    ...
    return (
        <>
                ...
                {todosFiltered().map((todo, index) => (
                    ...
                    <li className="todo-item-container">
                        <div className="todo-item">
                            ...
                            {!todo.isEditing ? (
                                <span onDoubleClick={() => markAsEditing(todo.id)} className={`todo-item-label ${todo.isComplete ? 'line-through' : ''}`}>
                                    {todo.title}
                                </span>
                            ) : (
                                <input
            ...
            <div className="toggles-container">
                <button onClick={setFeaturesOneVisible} className="button">Feature One Toggle</button>
